...
import { LeaseDepositCard } from "@/components/leases/LeaseDepositCard";
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="space-y-6 lg:space-y-8">
              ...
              {!isTenant && (
                <LeaseDepositCard
                  leaseId={lease._id}
                  fallbackAmount={lease.terms.securityDeposit}
                />
              )}
        ...
        <TabsContent value="payments" className="space-y-6">
          <div className="grid grid-cols-1 gap-6">
            ...
            <PaymentStatusDashboard
              ...
              onInvoiceGenerated={() => {
                showSimpleSuccess(
                  t("leases.details.toasts.invoiceGeneratedTitle"),
                  t("leases.details.toasts.invoiceGenerated"),
                );
              }}
            />
