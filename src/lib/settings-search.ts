...
const settingsIndex = [
  ...
  // Display Settings
  {
    ...
    category: "Display",
    path: "/dashboard/settings/appearance#theme",
    keywords: [
      "theme",
      "dark",
      "light",
  ...
  },
  {
    ...
    category: "Display",
    path: "/dashboard/settings/appearance#language",
    keywords: [
      "language",
      "timezone",
      "region",
  ...
  },
  {
    ...
    category: "Display",
    path: "/dashboard/settings/appearance#layout",
    keywords: [
      "layout",
      "typography",
      "font",
  ...
  },
  {
    ...
    category: "Display",
    path: "/dashboard/settings/appearance#colors",
    keywords: [
      "colors",
      "palette",
      "primary",
